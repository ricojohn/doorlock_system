                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('rfid-cards.update', $rfidCard) }}" method="POST" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" rows="3" placeholder="Additional notes about this key fob">{{ old('notes', $rfidCard->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary">Update Key Fob</button>
