        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">This configuration will be available for ESP32 devices to retrieve via API.</p>

                    <form action="{{ route('wifi-configurations.store') }}" method="POST" class="row g-3">
                        @csrf

                        <div class="col-md-6">
                            <label for="ssid" class="form-label">WiFi Name (SSID) <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('ssid') is-invalid @enderror" id="ssid" name="ssid" value="{{ old('ssid') }}" placeholder="e.g., MyWiFiNetwork" required>
                            @error('ssid')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" value="{{ old('password') }}" placeholder="Enter WiFi password" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" placeholder="Optional description (e.g., Main office WiFi, Guest network, etc.)">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary">Create WiFi Configuration</button>
