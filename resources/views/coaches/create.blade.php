        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('coaches.store') }}" method="POST" class="row g-3">
                        @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('specialty') is-invalid @enderror" id="specialty" name="specialty" value="{{ old('specialty') }}" placeholder="Strength, Rehab, HIIT, etc.">
                            @error('specialty')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
